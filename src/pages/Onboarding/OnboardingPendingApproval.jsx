    ...
    <div className="min-h-screen bg-slate-50/50 flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="mt-8 flex items-center justify-center gap-6 opacity-30 select-none">
          <a href="mailto:ayusydigital233@gmail.com" className="flex items-center gap-1.5 text-[10px] font-bold text-slate-900 hover:text-indigo-600 transition-colors">
            <Mail size={12} />
            Support
          </a>
