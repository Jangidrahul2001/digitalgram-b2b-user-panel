      ...
      >
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full p-8 flex justify-between items-start z-10">
            {/* <img src={LogoWhite} alt="digital gram Logo" className="h-8 w-auto object-contain" /> */}
          ...
          <div className="absolute bottom-0 left-0 w-full p-8 flex justify-between items-end z-10">
            <div className="flex items-center gap-3">
              ...
              <div className="text-white">
                ...
                <p className="text-[10px] uppercase font-bold text-white/60 tracking-wider font-mono">Digital Gram</p>
              </div>
            </div>
        ...
        >
          <div className="max-w-[440px] mx-auto w-full">
            ...
            <div className="mt-12 flex justify-center gap-7 text-slate-400">
              <a href="https://www.facebook.com" className="hover:text-indigo-600 transition-colors duration-300"><Facebook size={18} /></a>
              <a href="https://x.com" className="hover:text-indigo-600 transition-colors duration-300"><Twitter size={18} /></a>
              <a href="https://www.linkedin.com" className="hover:text-indigo-600 transition-colors duration-300"><Linkedin size={18} /></a>
              <a href="https://www.instagram.com" className="hover:text-indigo-600 transition-colors duration-300"><Instagram size={18} /></a>
            </div>

            <div className="mt-6 flex flex-col items-center">
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] flex items-center gap-1.5">
                Copyright © 2026 Digital Gram. All rights reserved.
              </span>
            </div>
          </div>
        </m.div>
